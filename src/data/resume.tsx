...
const result = new Date().toLocaleDateString("en-US", {
  month: "long",
  year: "numeric",
});
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/heyy-kartik",
        icon: Icons.github,
        navbar: true,
      },
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/kartik-jagdale-922475256/",
        icon: Icons.linkedin,
      ...
      Youtube: {
        name: "Youtube",
        url: "https://www.youtube.com/@neutron25",
        icon: Icons.youtube,
        navbar: false,
      },
      email: {
        name: "Send Email",
        url: " mailto: kartikjagdale0511@gmail.com",
        icon: Icons.email,
  ...
  education: [
    ...
    {
      school: "Wisdom high international school,Nashik ",
      href: "https://www.whis.edu.in/",
      degree: "Matriculation (Upto 10th)",
      logoUrl: "/schools.png",
      start: "2012",
      end: "2022",
    },
